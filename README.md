...
Before analysis, the cleaned table was validated to confirm that the data was reliable and suitable for analysis.

The validation process included:

- Confirming the final row count after import
...
![Manufacturing Defect Risk Dashboard](visuals/manufacturing_defect_risk_dashboard.jpg)

---

## SQL Result Screenshots

Detailed SQL result screenshots are available in the [`visuals/sql-results`](visuals/sql-results) folder.

---

## Key Findings

1. The overall defect status rate was **84.04%**, showing a high-defect production environment.
2. High maintenance hours showed the strongest defect-risk separation, with a **96.15%** defect status rate.
3. Low quality score records had a **95.80%** defect status rate.
4. High production volume records had a **91.16%** defect status rate.
5. Downtime percentage, supplier quality, and worker productivity were weaker signals.
6. Records with no major risk factors had a much lower defect status rate of **53.89%**.
7. Records with one or more major risk factors had defect status rates above **92%**.
